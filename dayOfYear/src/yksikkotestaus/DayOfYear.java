...
public class DayOfYear {	
    ...
    public static int dayOfYear(int month, int dayOfMonth, int year) {
    	...
    	Year currentYear = Year.of(year);		//parse year(int) to Year 
    	boolean leap  = currentYear.isLeap();	//check if it's leap year
    	
    	Month[] months= Month.values();			//initialize list of months
    	
    	int days = dayOfMonth;	/*Separate number of day from input number for calculating purpose. "days" will be total nomber of days
...
Year leap = Year.of(year);			//checking if it's leap year. WARNING!!! his is accurate only between years 1901-2099 
if (leap.isLeap() == true) {
